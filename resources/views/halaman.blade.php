    ...
    <header class="header-area">
        ...
        <div class="logo-area text-center">
            <div class="container h-100">
                <div class="row h-100 align-items-center">
                    <div class="col-12">
                        <a href="/blog" class="original-logo"><img src="assets/img/core-img/logo.png" alt=""></a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="row h-100 align-items-center">
                        <div class="col-12">
                            <div class="slide-content text-center">
                                ...
                                <h2 data-animation="fadeInUp" data-delay="250ms"><a href="/post">Take a look at last night’s party!</a></h2>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-12 col-md-4 col-lg-3">
                    <div class="post-sidebar-area">
                        ...
                        <div class="sidebar-widget-area">
                            ...
                            <a href="#"><img src="assets/img/bg-img/add.gif" alt=""></a>
                        </div>
                            ...
                            <div class="widget-content">
                                ...
                                <div class="single-blog-post d-flex align-items-center widget-post">
                                    ...
                                    <div class="post-thumbnail">
                                        <img src="assets/img/blog-img/lp1.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                ...
                                <div class="single-blog-post d-flex align-items-center widget-post">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="assets/img/blog-img/lp2.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <a href="#" class="post-tag">Lifestyle</a>
                                ...
                                <div class="single-blog-post d-flex align-items-center widget-post">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="assets/img/blog-img/lp3.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <a href="#" class="post-tag">Lifestyle</a>
                                ...
                                <div class="single-blog-post d-flex align-items-center widget-post">
                                    <!-- Post Thumbnail -->
                                    <div class="post-thumbnail">
                                        <img src="assets/img/blog-img/lp4.jpg" alt="">
                                    </div>
                                    <!-- Post Content -->
                                    <div class="post-content">
                                        <a href="#" class="post-tag">Lifestyle</a>
    ...
    <div class="instagram-feed-area">
        ...
        <div class="instagram-slides owl-carousel">
            ...
            <div class="single-insta-feed">
                <img src="assets/img/instagram-img/1.png" alt="">
                <!-- Hover Effects -->
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="assets/img/instagram-img/2.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="assets/img/instagram-img/3.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="assets/img/instagram-img/4.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="assets/img/instagram-img/5.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="assets/img/instagram-img/6.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
            ...
            <!-- Single Insta Feed -->
            <div class="single-insta-feed">
                <img src="assets/img/instagram-img/7.png" alt="">
                <!-- Hover Effects -->
                <div class="hover-effects">
                    <a href="#" class="d-flex align-items-center justify-content-center"><i class="fa fa-instagram"></i></a>
                </div>
